...
*  data: io_data type ZTIRBKEMP3TP,
*        lr_data type  ZSIRBKEMP3TP,
*        io_data1 type ZTIRBKEMP2TP1,
*        lr_data1 TYPE  ZSIRBKEMP2TP1,
...
*           iv_node                 = ZIF_I_RBKEMPTP12_C=>sc_node-zi_rbkemp3tp           " Node Name
*           it_key                  =  it_key               " Key Table
*           iv_association          = ZIF_I_RBKEMPTP12_C=>sc_association-zi_rbkemp3tp-to_parent              " Name of Association
**           is_parameters           =
...
*          lv_message-msgv1 = 'Employee ID does not match'.
*
*
