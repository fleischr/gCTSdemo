  method /BOBF/IF_FRW_DETERMINATION~EXECUTE.
     DATA: io_data          TYPE ZTIRBKEMP2TP,  "combined table type
    ...
    CALL METHOD io_read->retrieve
      EXPORTING
        iv_node = ZIF_I_RBKEMPTP11_C=>sc_node-zi_rbkemp2tp  " Node Name
    ...
    LOOP AT io_data REFERENCE INTO lr_data .
      IF lr_data->emp_country = 'INDIA' .
        lr_data->emp_city = 'BANGALORE' .
        io_modify->update(
  EXPORTING
    iv_node           = ZIF_I_RBKEMPTP11_C=>sc_node-zi_rbkemp2tp   " Node
